// js/inventario.js - GESTIÓN DE STOCK Y RECETAS (SOLUCIÓN DEFINITIVA V6.1)
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // ── 🆕 MOVIDO AQUÍ ADENTRO: Ver insumos faltantes ──────────────────
    window.verFaltantes = async () => {
        ...
        try {
            const { data, error } = await window.db
                ...
                .eq('restaurante_id', restoId) // Ahora sí tiene acceso a restoId
